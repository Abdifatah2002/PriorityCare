        ...
        if (commands.length < 4) {
            ...
            try {
                ...
                if (commands[2].length() != 1) {
                    ...
                    if (Integer.parseInt(commands[0]) == 3) {
                        newPatient.seePatient();
                    }
