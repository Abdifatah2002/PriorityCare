...
public class PatientRecord implements Comparable<PatientRecord> {
    ...
    /**
     * counts the number of patients created, Begins at 1, and
    ...
    /**
     * This patient's triage level
     * Red<Yellow<Green
     */

    private TriageLevel triage; // This patient's triage level // RED < YELLOW < GREEN
    /**
     * This patient's single -character gender marker
     */
    ...
    /**
     * The order in which this patient arrived; taken from the value of patientCounter when this record was created
     */
    ...
    /**
     * tells whether this patient has been mrket as " seen"
     */
    ...
    public int compareTo(PatientRecord other) {
        ...
        // If triage levels are the same, compare order of arrival
        if (triageComparison == 0) {
            return this.orderOfArrival - other.orderOfArrival;
        }

        // Otherwise, return the triage comparison result
